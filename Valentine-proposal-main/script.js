function showMessage(response) {
  ...
  if (response === "No") {
      ...
      document.getElementsByClassName("image")[0].src = "images/no.jpg";
      ...
      noButton.addEventListener("mouseover", () => {
          if (!videoPlayed) {
              ...
              videoElement.src = "./mylove.mp4#t=42";
  ...
  if (response === "Yes") {
      ...
      yesMessage.textContent = "I wish I will be kissing you on the next Valentine and not missing you like today. Happy Valentine’s Day, baby. There is nothing more I want for this Valentine’s Day than you celebrating this day with me. I love you and miss you soo soo much, my Mahi baby.";
      yesMessage.style.display = "block";
      yesMessage.style.fontStyle = "normal";
      document.getElementsByClassName("image")[0].src = "images/mahi.jpg";
